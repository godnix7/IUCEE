...
Revision ID: 72100c595348
Revises: 
Create Date: 2026-08-16 22:25:08.432210
...
def upgrade() -> None:
    ...
    sa.Column('original_crs', sa.String(), nullable=True),
    sa.Column('normalized_crs', sa.String(), nullable=True),
    ...
    sa.Column('inference_time_sec', sa.Float(), nullable=True),
    ...
    op.create_index('idx_imagery_analyses_footprint', 'imagery_analyses', ['footprint'], unique=False, postgresql_using='gist')
    op.create_index(op.f('ix_imagery_analyses_id'), 'imagery_analyses', ['id'], unique=False)
    op.create_index(op.f('ix_imagery_analyses_project_id'), 'imagery_analyses', ['project_id'], unique=False)
    op.create_index(op.f('ix_imagery_analyses_status'), 'imagery_analyses', ['status'], unique=False)
    ...
    op.create_index('idx_spatial_features_geometry', 'spatial_features', ['geometry'], unique=False, postgresql_using='gist')
    op.create_index(op.f('ix_spatial_features_analysis_id'), 'spatial_features', ['analysis_id'], unique=False)
    op.create_index(op.f('ix_spatial_features_class_name'), 'spatial_features', ['class_name'], unique=False)
    op.create_index(op.f('ix_spatial_features_id'), 'spatial_features', ['id'], unique=False)
    op.create_table('urban_benchmarks',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('analysis_id', sa.Integer(), nullable=True),
    sa.Column('population_count', sa.Integer(), nullable=True),
    sa.Column('road_density_km_per_sqkm', sa.Float(), nullable=True),
    ...
    sa.Column('built_up_ratio', sa.Float(), nullable=True),
    sa.Column('hospitals_per_10k_pop', sa.Float(), nullable=True),
    sa.Column('schools_per_10k_pop', sa.Float(), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_urban_benchmarks_id'), table_name='urban_benchmarks')
    op.drop_index(op.f('ix_urban_benchmarks_analysis_id'), table_name='urban_benchmarks')
    op.drop_table('urban_benchmarks')
    op.drop_index(op.f('ix_spatial_features_id'), table_name='spatial_features')
    op.drop_index(op.f('ix_spatial_features_class_name'), table_name='spatial_features')
    op.drop_index(op.f('ix_spatial_features_analysis_id'), table_name='spatial_features')
    op.drop_index('idx_spatial_features_geometry', table_name='spatial_features', postgresql_using='gist')
    op.drop_table('spatial_features')
    op.drop_index(op.f('ix_imagery_analyses_status'), table_name='imagery_analyses')
    op.drop_index(op.f('ix_imagery_analyses_project_id'), table_name='imagery_analyses')
    op.drop_index(op.f('ix_imagery_analyses_id'), table_name='imagery_analyses')
    op.drop_index('idx_imagery_analyses_footprint', table_name='imagery_analyses', postgresql_using='gist')
